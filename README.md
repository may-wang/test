...
<param ve-map time-selector="3500 BCE:0" basemap="Esri_WorldPhysical" center="0,50" zoom="3" hide-labels>
<param ve-map-layer type="geojson" active="true" url="https://github.com/may-wang/test/blob/master/watermelondistribution.json" title="Spread">
